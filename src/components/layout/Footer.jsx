                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {
                                CompanySections?.map((list, index) => {
                                    return (<li><a href="#" className="text-gray-900 hover:text-gray-700" key={index}>{list}</a></li>)
                                })
                            }
                    ...
                    {/* Products */}
                    <div>
                        <h3 className="text-gray-900 font-semibold text-lg mb-4">Products</h3>
                        <ul className="space-y-2">
                            {
                    ...
                    {/* Legal */}
                    <div>
                        <h3 className="text-gray-900 font-semibold text-lg mb-4">Legal</h3>
                        <ul className="space-y-2">
                            {
